...
For each dataset, we calculated measured the performance of each source in terms of our evaluation metrics. We report the top 5 performing sources on each data set in terms of the accuracy evaluation metric.  
...
\hline
A1Books &  0.68 \\Revaluation Books & 0.63	\\Papamedia.com & 0.49	 \\paperbackworld.de & 0.38	  \\Caiman & 0.34	 \\
 \hline
 \end{tabular}
