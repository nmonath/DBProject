...
We have defined the framework, which can be used for all of the algorithms. We have implemented the Majority Voting, Maximum Likelihood Estimation, TruthFinder, and the proposed extension to TruthFinder. We have begun our implementation of the Conflict Resolution on Heterogenous Data algorithm. Our framework in place easily facilitates the ensemble methods.  We are in the process evaluating these methods. 
