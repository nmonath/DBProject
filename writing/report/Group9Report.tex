...
We also used three synthetic data sets. These data sets are the \emph{credit approval data set}, \emph{prima indians diabetes data set} and the \emph{adult data set}. The data sets are available at the \emph{Machine Learning Repository}\footnote{\url{https://archive.ics.uci.edu/ml/datasets/Adult}}
\footnote{\url{https://archive.ics.uci.edu/ml/datasets/Credit+Approval}} \footnote{\url{https://archive.ics.uci.edu/ml/datasets/Pima+Indians+Diabetes}}. We used the original data sets as gold standard and produced synthetic data sets with noise. For the noisy data sets we defined synthetic sources. Each of the sources has two parameters: a parameter for continuous attributes which introduces Gaussian noise to continuous values, and a parameter 
...
\hline
 ...
 Diabetes &  20&   768 & 8 &  BMI, blood pressure   \\
\hline
\end{tabular}
}
