...
A summary of the names of the variables used in this report is given in Table \ref{tbl:vars}, and an example of each variable is given in Table \ref{tbl:varExs}. 
